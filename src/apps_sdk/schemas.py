...
class CheckoutInput(BaseModel):
    ...
    razorpay_payment_id: str | None = Field(
        None, alias="razorpayPaymentId", description="Razorpay Payment ID for completion"
    )
    razorpay_order_id: str | None = Field(
        None, alias="razorpayOrderId", description="Razorpay Order ID for completion"
    )
    razorpay_signature: str | None = Field(
        None, alias="razorpaySignature", description="Razorpay Signature for completion"
    )
    session_id: str | None = Field(
        None, alias="sessionId", description="Session ID for completion"
    )
