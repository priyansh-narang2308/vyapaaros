...
| **Primary LLM** | **VyapaarOS Nemotron-3-Nano-30B** | **v3 (Dec 2025)** | Agent Core Logic | Sparse MoE design for high inference throughput. |
...
| **Inference Engine** | **VyapaarOS NIM / TensorRT-LLM** | 25.11+ | Optimized Execution | Configurable: local Docker or public VyapaarOS API endpoint. |
| **Embedding Model** | **VyapaarOS NV-EmbedQA-E5-v5** | latest | RAG for Recommendations | Semantic product search for ARAG retrieval pipeline. |
