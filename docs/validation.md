...
* **[ ] 1.2 Development Environment:** Local setup specifies **Python 3.12+** and the required **VyapaarOS NIM** / **NAT** environment variables for the **Nemotron-3-Nano** LLM.
...
* **[ ] 2.7 NIM Configuration:** Inference engine configurable via environment variable (VyapaarOS hosted API or local Docker).
